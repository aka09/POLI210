...
E-mail: $if(email)$\texttt{$email$}$else$TBD$endif$ & Class Hours: $if(classhours)$$classhours$$else$TBD$endif$\\
...
\noindent \begin{tabular*}{\textwidth}{ @{\extracolsep{\fill}} lr @{\extracolsep{\fill}}}
TA: $ta1$ &
E-mail: $if(emailta1)$\texttt{$emailta1$}$else$ $endif$\\
Office hours: $ohta1$ &
Office: $officeta1$ \\
\hline
\end{tabular*}
...
\noindent \begin{tabular*}{\textwidth}{ @{\extracolsep{\fill}} lr @{\extracolsep{\fill}}}
	TA: $ta2$ &
	E-mail: $if(emailta2)$\texttt{$emailta2$}$else$ $endif$\\
	Office hours: $ohta2$ &
	Office: $officeta2$ \\
	\hline
\end{tabular*}
...
\noindent \begin{tabular*}{\textwidth}{ @{\extracolsep{\fill}} lr @{\extracolsep{\fill}}}
	TA: $ta3$ &
	E-mail: $if(emailta3)$\texttt{$emailta3$}$else$ $endif$\\
	Office hours: $ohta3$ &
	Office: $officeta3$ \\
	\hline
\end{tabular*}
...
\noindent \begin{tabular*}{\textwidth}{ @{\extracolsep{\fill}} lr @{\extracolsep{\fill}}}
	TA: $ta4$ &
	E-mail: $if(emailta4)$\texttt{$emailta4$}$else$ $endif$\\
	Office hours: $ohta4$ &
	Office: $officeta4$ \\
	\hline
\end{tabular*}
