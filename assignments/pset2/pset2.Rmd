...
```{marginfigure}
It looks like there are similar proportions of women in the two experimental conditions. This is exactly what we expect given random assignment: the two groups should be, on average, just about the same on all pre-treatment covariates. 
```
