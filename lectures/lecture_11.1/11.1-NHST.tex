...
\tightlist
\item
  Problem set 4 will be posted today; \textbf{mandatory}
\item
  Due dates:
...
\protect\hypertarget{final-project}{}
\begin{itemize}
\tightlist
\item
  1500 words
...
\begin{frame}{Articles to choose from}
\protect\hypertarget{articles-to-choose-from}{}
\footnotesize

\begin{table}[!h]
\centering\begingroup\fontsize{6}{8}\selectfont

\begin{tabular}{>{\raggedright\arraybackslash}p{12em}>{\raggedright\arraybackslash}p{8em}>{\raggedright\arraybackslash}p{14em}>{\raggedright\arraybackslash}p{9em}}
\toprule
\textbf{Article} & \textbf{Authors} & \textbf{Substantive content} & \textbf{Methodology}\\
\midrule
...
Post-Soviet Eurasia & Henry E. Hale & The success or failure of transitions to democracy in post-communist Eurasia & Comparative analysis\\
\bottomrule
\end{tabular}
\endgroup{}
\end{table}
...
\begin{frame}{Exploration of midterm data}
\protect\hypertarget{exploration-of-midterm-data}{}
\includegraphics[width=1\linewidth]{11.1-NHST_files/figure-beamer/unnamed-chunk-2-1}
\end{frame}

\begin{frame}{Exploration of midterm data}
\protect\hypertarget{exploration-of-midterm-data-1}{}
\includegraphics[width=1\linewidth]{11.1-NHST_files/figure-beamer/unnamed-chunk-3-1}
\end{frame}
...
\caption{\label{tab:unnamed-chunk-7}Grades of students you meet in lab}
\centering
\begin{tabular}[t]{lr}
\toprule
Student \# & Grade\\
...
\caption{\label{tab:unnamed-chunk-8}Grades of students you meet in lab}
\centering
\begin{tabular}[t]{lr}
\toprule
Student \# & Grade\\
...
\caption{\label{tab:unnamed-chunk-9}Grades of students you meet in lab}
\centering
\begin{tabular}[t]{lr}
\toprule
Student \# & Grade\\
...
\includegraphics[width=0.75\linewidth]{11.1-NHST_files/figure-beamer/unnamed-chunk-11-1}
\end{frame}
...
\begin{frame}{p = 0.4 (with non-directional hypothesis)}
\protect\hypertarget{p-0.4-with-non-directional-hypothesis}{}
\includegraphics[width=1\linewidth]{11.1-NHST_files/figure-beamer/unnamed-chunk-17-1}
\end{frame}

\begin{frame}{p = 0.2 (with non-directional hypothesis)}
\protect\hypertarget{p-0.2-with-non-directional-hypothesis}{}
\includegraphics[width=1\linewidth]{11.1-NHST_files/figure-beamer/unnamed-chunk-18-1}
\end{frame}

\begin{frame}{p = 0.1 (with non-directional hypothesis)}
\protect\hypertarget{p-0.1-with-non-directional-hypothesis}{}
\includegraphics[width=1\linewidth]{11.1-NHST_files/figure-beamer/unnamed-chunk-19-1}
\end{frame}

\begin{frame}{p = 0.05 (with non-directional hypothesis)}
\protect\hypertarget{p-0.05-with-non-directional-hypothesis}{}
\includegraphics[width=1\linewidth]{11.1-NHST_files/figure-beamer/unnamed-chunk-20-1}
\end{frame}
...
\caption{\label{tab:unnamed-chunk-22}Grades of students you meet in lab}
\centering
\begin{tabular}[t]{lrr}
\toprule
...
The difference-in-means is different from 0 in a \textbf{statistically
significant} manner
\end{frame}
...
\begin{frame}{How to interpret the difference-in-means}
\protect\hypertarget{how-to-interpret-the-difference-in-means}{}
...
\item
  Well, it depends!
\item
  If they're means from experimental conditions \(\leadsto\) causal
  interpretation
\item
...
\begin{frame}{The dangers of hypothesis testing}
\protect\hypertarget{the-dangers-of-hypothesis-testing}{}
...
\begin{frame}{Political Analysis}
\protect\hypertarget{political-analysis}{}
\includegraphics{pa_pvalues.png}
\end{frame}

\begin{frame}{``p-hacking''}
\protect\hypertarget{p-hacking}{}
We've seen that there a (completely arbitrary) threshold below which
...
\item
  Incentive: play around with data until you achieve p \textless{} 0.05

  \begin{itemize}
  \tightlist
  \item
    Play around: add/remove control variables, remove observations, use
    alternative measures\ldots{}
  \end{itemize}
\item
  Called: p-hacking, researcher degrees of freedom, garden of forking
  paths\ldots{}
\item
  This is a \textbf{widespread} problem that we are just starting to
  grapple with
\item
  But when you think about it\ldots{}

  \begin{itemize}
  \tightlist
  \item
    Are you really more certain of your result if p = 0.049 compared to
    p = 0.051?
  \end{itemize}
\end{itemize}
\end{frame}

\begin{frame}{Wrong side of the arbitrary threshold}
\protect\hypertarget{wrong-side-of-the-arbitrary-threshold}{}
\begin{columns}[T]
\begin{column}{0.48\textwidth}
\includegraphics{pvalue_disappointment1.png}
\end{column}

\begin{column}{0.48\textwidth}
\includegraphics{pvalue_disappointment2.png}
\end{column}
\end{columns}
\end{frame}

\begin{frame}{Jelly beans and acne}
\protect\hypertarget{jelly-beans-and-acne}{}
\includegraphics{phacking_xkcd.png}
\end{frame}

\begin{frame}{Significance}
\protect\hypertarget{significance}{}
\centering

\includegraphics[width=\textwidth,height=0.9\textheight]{significance_xkcd.png}
\end{frame}

\begin{frame}{Significance as a dummy}
\protect\hypertarget{significance-as-a-dummy}{}
Your results are either statistically significant or they're not

\begin{itemize}
\tightlist
\item
  If p = 0.06 and you set \(\alpha = 0.05\), your finding is not
...
You will often see papers that ignore this because they want significant
results (remember publication bias?)

\begin{itemize}
\tightlist
\item
  ``approaches significance'', ``marginally significant''\ldots{}
\item
  For a longer (and hilarious) list,
  \href{https://mchankins.wordpress.com/2013/04/21/still-not-significant-2/}{see
  here} \footnotesize
\item
  ``As well as being statistically flawed (results are either
  significant or not and can't be qualified), the wording is
  linguistically interesting, often describing an aspect of the result
  that just doesn't exist. For example, ``a trend towards significance''
  expresses non-significance as some sort of motion towards
  significance, which it isn't: there is no `trend', in any direction,
  and nowhere for the trend to be `towards'."
\end{itemize}
\end{frame}

\begin{frame}{Statistical vs substantive significance}
\protect\hypertarget{statistical-vs-substantive-significance}{}
Above all, \textbf{we may not care about a statistically significant
finding}

Statistical significance \(\neq\) substantive significance

It is possible to have a statistically significant difference that is
substantively not meaningful

\begin{itemize}
\tightlist
\item
  e.g.~a large survey (60,000) shows that mean happiness for Facebook
  users is 7.64 on 1-10 scale and 7.68 for non-Facebook users
\item
  Given the sample size, we may find a \emph{statistically} significant
  different difference, e.g.~\(p < 0.01\)
\item
  ...
  \tightlist
  \item
    \textbf{Substantive} significance: does it pass the ``so what''
    test?
  \end{itemize}
\end{itemize}
\end{frame}
...
Real-world decisions and our understanding of the world depend on our
interpretation of ours results

\begin{itemize}
\tightlist
\item
  And our interpretation depends on whether we have statistical
  significance
\end{itemize}

\includegraphics{colchicine.png}
\end{frame}

\begin{frame}{Why should I care?}
\protect\hypertarget{why-should-i-care-1}{}
\includegraphics{colchine_results.png}
\end{frame}
